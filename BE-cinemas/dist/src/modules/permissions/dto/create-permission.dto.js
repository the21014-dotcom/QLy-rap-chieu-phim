...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Tên quyền không được để trống' }),
...
__decorate([
    ...
    __metadata("design:type", String)
], CreatePermissionDto.prototype, "api_path", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
class UpdatePermissionDto extends (0, mapped_types_1.PartialType)(CreatePermissionDto) {
}
